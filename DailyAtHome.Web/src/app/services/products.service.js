...
var ProductsService = (function () {
    ...
    ProductsService.prototype.getSubCategoriesByCategoryID = function (id) {
        return this.http.get(app_settings_1.AppSettings.API_URL + '/api/header/GetSubcategoriesByCategoryID/' + id).map(function (response) { return response.json(); });
    };
