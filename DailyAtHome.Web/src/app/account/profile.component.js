...
var ProfileComponent = (function () {
    function ProfileComponent(_authSvc, _formBuilder) {
    ...
    ProfileComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._authSvc.getUser().subscribe(function (res) {
            _this.address = res.Adresses;
        });
    };
    ProfileComponent.prototype.billingEdit = function (i) {
