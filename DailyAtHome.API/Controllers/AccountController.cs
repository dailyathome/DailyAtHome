...
using DailyAtHome.API.Models;
using DailyAtHome.API.Providers;
using DailyAtHome.API.Results;
using DailyAtHome.API.ViewModels;
using DailyAtHome.Models;
using DailyAtHome.DataContracts;
using System.Web.Security;
using System.Security.Principal;
using System.Threading;
using DailyAtHome.API.Attributes;
using System.Web.Http.Cors;
using System.Net;

namespace DailyAtHome.API.Controllers
{
    //[Authorize]
    ...
    public class AccountController : ApiController
    {
        ...
        //    {
        //        return Request.CreateErrorResponse(HttpStatusCode.Unauthorized,"Unothrized");
        //    }
        //    User user = new User()
        //    {
        //        Email = vm.Email,
        ...
        //    };
        //    user = _accountDac.GetUserDetails(user);
